...
ARG QOVERY_DATABASE_ROMNUMRD_CONNECTION_URI='redis://redis'
ENV REDIS_URL=$QOVERY_DATABASE_ROMNUMRD_CONNECTION_URI
RUN echo "REDIS_URL set to $REDIS_URL"

ARG QOVERY_DATABASE_ROMNUMDB_CONNECTION_URI='mysql://mysql'
ENV DATABASE_URL=$QOVERY_DATABASE_ROMNUMDB_CONNECTION_URI
